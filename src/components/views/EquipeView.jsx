...
const tabs = [
    ...
    { id: "investigateurs", label: "Investigateurs", icon: Search, className: "w-4 h-4" },
    { id: "administrateurs", label: "Administrateurs", icon: Shield, className: "w-4 h-4" },
    { id: "roles", label: "Rôles et Permissions", icon: Key, className: "w-4 h-4" },
];
            ...
            <div className="grid grid-cols-1 gap-1">
                {criteria.map((criterion, index) => (
                    <div key={index} className="flex items-center gap-2 text-sm">
                        ...
                        <span className={criterion.met ? "text-green-700 font-medium" : "text-gray-500"}>
              {criterion.label}
            </span>
                    </div>
                ))}
...
const EquipeView = () => {
    ...
    const handleRoleChange = (e) => {
        ...
        else if (newRole === "Investigateur") defaultDepartement = "CAC";
    ...
    const handlePasswordSubmit = async (e) => {
        ...
        try {
            const payload = { newpassword: passwordForm.password };
    ...
    const getAvailableDepartements = () => {
        ...
        if (role === "Investigateur") return departementsInvestigateur;
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                        ...
                        <div className="grid md:grid-cols-3 gap-6">
                            {STANDARD_ROLES.map((role) => (
                                <div
                                    key={role.id}
                                    className="border rounded-xl p-5 hover:border-blue-300 transition-colors bg-gray-50"
                                >
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-xs text-gray-500 mt-1">
                                                    ...
                                                    {formData.role === "Investigateur" && "Départements: CAC, DAJ"}
                                                    {formData.role === "Admin" &&
