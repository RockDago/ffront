// src/components/DashboardAgent.jsx - DÉSACTIVER VÉRIFICATION PROFILE (MODE DÉMO)
import React, { useState, useEffect } from "react";
import AuthService from "../services/authService"; // ✅ Utilise données localStorage
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="flex pt-20">
        ...
        >
          ...
          {currentView === "signalements" && <ReportsView data={agentData} />}
